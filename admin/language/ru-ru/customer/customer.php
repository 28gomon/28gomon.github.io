...
// Text
$_['text_success']          = 'Информация о клиенте успешно изменена!';
...
// Help
$_['help_safe']             = 'Включите, чтобы система по борьбе с мошенничеством - игнорировала этого клиента.';
$_['help_points']           = 'Используйте минус - чтобы удалить бонусные баллы';

// Error
$_['error_warning']         = 'Внимание: проверьте форму на наличие ошибок!';
$_['error_permission']      = 'Внимание: вы не имеете доступ к изменению информации о клиентах!';
