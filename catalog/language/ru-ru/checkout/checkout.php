...
$_['text_i_am_returning_customer']   = 'Я совершал здесь заказ трансфера ранее и регистрировался';
$_['text_register']                  = 'Зарегистрироваться';
$_['text_guest']                     = 'Оформить заказ без регистрации';
$_['text_register_account']          = 'Создание учётной записи поможет делать заказ трансфера быстрее и удобнее, не внося одни и те же данные многократно (адрес доставки, имя, телефон и т.д.) Вы также, сможете отслеживать статус своего заказа, пользоваться Закладками, видеть свои предыдущие заказы, накапливать бонусные баллы (можно оплатить поезку частично или полностью!) или получить скидку как постоянный клиент.';
...
$_['text_shipping_method']           = 'Выберите удобный способ доставки трансфера для этого заказа:';
