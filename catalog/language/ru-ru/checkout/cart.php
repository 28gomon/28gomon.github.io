<?php
// Heading
$_['heading_title']            = 'Услуги для заказа';

// Text
$_['text_success']             = 'Услуга <a href="%s">%s</a> добавлена в вашу <a href="%s">форму</a>!';
$_['text_remove']              = 'Корзина услуг успешно обновлена!';
$_['text_login']               = 'Вам необходимо <a href="%s">авторизоваться</a> или <a href="%s">создать аккаунт</a> для просмотра цен!';
$_['text_items']               = '%s - км. Заказ на - %s';
...
$_['text_empty']               = 'Нет заявок на трансфер';
$_['text_day']                 = 'день';
$_['text_week']                = 'неделя';
...
$_['column_price']           = 'Цена за усл.';
$_['column_total']           = 'Всего';

// Error
$_['error_stock']              = 'Продукты отмеченные *** отсутствуют в нужном количестве или их нет в наличии!';
$_['error_minimum']            = 'Минимально для заказа %s равняется %s!';
$_['error_required']           = '%s необходим!';
$_['error_product']            = 'Вы не добавили ни одной услуги трансфера!';
