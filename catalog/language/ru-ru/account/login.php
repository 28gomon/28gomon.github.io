...
$_['text_register_account']        = 'Создание учетной записи поможет делать следующие заказы быстрее (не надо будет снова вводить адрес и контактную информацию), видеть состояние заказа, а также видеть заказы, сделанные ранее. Вы также сможете накапливать при заказах призовые баллы (на них тоже можно оплатить частично или полностью поездку), а постоянным клиентам мы предлагаем систему скидок.';
