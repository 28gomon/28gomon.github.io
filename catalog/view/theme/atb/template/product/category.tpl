        ...
        <?php } ?>
            <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
                <div class="product-category clearfix">
                    ...
                    <?php if (count($categories) <= 1000) { ?>
                    <div class="row">
                        <div class="col-sm-12">
                            <ul class="name-service">
                    ...
                    <?php } else { ?>
                    <div class="row">
                        <?php foreach (array_chunk($categories, ceil(count($categories) / 1000)) as $categories) { ?>
                        <div class="col-sm-12">
                            <ul>
                                <?php foreach ($categories as $category) { ?>
                                <li><a href="<?php echo $category['href']; ?>"><?php echo $category['name']; ?></a></li>
                                ...
                                <div>
                                    ...
                                    <div class="button-group">
                                        <button type="button"
                                            ...
                                            <i class="fa fa-taxi"></i> <span
                                                    class="button-order-1"><?php echo $button_cart; ?></span>
                                        </button>
                                    </div>
